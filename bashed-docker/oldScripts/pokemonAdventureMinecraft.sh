...
HOSTDATA=/mnt/user/app/dockerhub/itzg-minecraft-server/dataPokemonAdventureReloaded
...
sudo docker run -d -v $HOSTDATA:/data \
    -e VERSION=1.10.2 \
    -e TYPE=FORGE -e FORGEVERSION=12.18.3.2185 \
    -e 'MOTD=Twitch Pokemon Adventure' \
    -e OPS=QuirkySpirit,Notebook,Muaddib,QuirkySpirit1,Notebook1,Muaddib1 \
    -e SEED=2305120 \
    -e MODE=creative \
